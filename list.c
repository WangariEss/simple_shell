...
/**
 * key_check -function that check if the alias aread exist
...
/**
*print_list - function that print elements of a linked list
...
/**
*add_list - function that add node to the end of the list
*@head: pointer to the head of the list
...
/**
 * check_list - function that get the value of a given key from the alias list
