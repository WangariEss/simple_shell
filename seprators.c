...
/**
 * check_seprator - function that check one of the oprators
...
/**
 * semcolen - function that do the same as ; oprator do in sh shell
...
/**
 * anding - function that do the same as && oprator do in sh shell
 * @line: pointer to string of the line
 * @head: pointer to the head of list of alias
 * @head_asign: pointe to list of varible replacement
 */
...
/**
 * oring - function that do the same as || oprator do in sh shell
 * @line: pointer to string of the line
 * @head: pointer to the head of list of alias
 * @head_asign: pointe to list of varible replacement
 */
