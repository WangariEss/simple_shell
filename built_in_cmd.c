...
/**
 * _setenv - function that add environ variable
...
/**
 * _unsetenv - function that delete environ variable
 * from the environment list
 * @argv: dounble pointer to the argurments
 * @head: pointer to struct of list_t
 */
...
/**
 * change_cd - function that chanage the directory
 * @argv: double pointer to the argurments
 * @head: pointer to struct of list_t
*/
...
/**
 * alias - functiom that addes alias to the alias list
 * @argv: double pointer to the argurments
 * @head: pointer to struct of list_t
 */
