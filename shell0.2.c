...
/**
 * _error - function that print error messesge
...
/**
 * print_prompt - function that print prompt
 * @ac: num of arguments
 */
...
/**
 * file_script - function that handle file script
...
/**
 * main - function that act like sh shell
 * @ac: num of arguments
 * @av: array of strings of the arguments
 * Return: 0
 */
