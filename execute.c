...
/**
 * check_comment - function that delete any comments if exits
...
/**
 * check_command - function that check if there the is built-in
...
/**
 * check_asign - function that add the argument to the asign list
...
/**
 * execute - function that execute a given command
...
/**
 * execute_line - function that take a given line execute it
