...
#include <stdio.h>
/**
 * check_begin_space - function that delete the spaces from
...
/**
*check_word - function that get num on words in the str
...
/**
 * split_str_2 - function that spilt string with respect to qoutes
